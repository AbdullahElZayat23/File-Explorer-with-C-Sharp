    ...
    public partial class ExplorerBrowserMainForm : Form
    {
        ...
        private void chooseToolStripMenuItem_Click(object sender, EventArgs e)
        {
            using (BrowseForFolder dialog = new BrowseForFolder())
            {
                ...
                {
                    if (dialog.SelectedFolderIdList.Count>0) {
        ...
        //not added on the form(moved to start form)
        //working on it
        private void advancedSearchToolStripMenuItem_Click(object sender, EventArgs e)
        {
            JamSearchMainForm advform = new JamSearchMainForm();
            advform.Show();
        }
